...
const alertRegex = /^\[!(NOTE|TIP|IMPORTANT|WARNING|CAUTION|QUESTION|YAKTON|YAKASH)\]/i;
const alertLegacyRegex = /^\[!(NOTE|TIP|IMPORTANT|WARNING|CAUTION|QUESTION|YAKTON|YAKASH)(\/.*)?\]/i;
...
type IconType = 'note' | 'tip' | 'important' | 'warning' | 'caution' | 'question' | 'yakton' | 'yakash';

// These values are the d paths from SVGs. Copy an SVG, paste it, and take what's between quotes in <path d="" />
